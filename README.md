...
3.  **Ghostface Analiza (AI Insights)**:
    - Kada odaberete nekog lika, sustav će generirati "Ghostface Analysis". To je poseban AI uvid koji analizira karakter i sudbinu odabranog lika.
...
Za one koji žele dublje istražiti kako je cijela ova socijalna mreža strukturirana i koja je metodologija korištena, dostupan je detaljan izvještaj u datoteci [report_1.md](./report/report_1.md).
