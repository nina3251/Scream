...
export const screamData: ScreamData = {
  ...
  relationships: [
    // Family Links
    { source: 'maureen-prescott', target: 'sidney-prescott', type: 'family', strength: 5, reason: 'Majka i kći. Maureeno ubojstvo je trauma koja je definirala Sidneyin život.' },
    { source: 'maureen-prescott', target: 'roman-bridger', type: 'family', strength: 5, reason: 'Majka i napušteni sin. Maureenino odbacivanje Romana stvorilo je ultimativnog negativca.' },
    { source: 'maureen-prescott', target: 'kate-roberts', type: 'family', strength: 5, reason: 'Sestre, dijelile su obiteljske tajne Woodsboroa.' },
    { source: 'kate-roberts', target: 'jill-roberts', type: 'family', strength: 5, reason: 'Majka i kći. Jillina ogorčenost obitelji potaknula je njezin ubilački pohod.' },
    { source: 'sidney-prescott', target: 'jill-roberts', type: 'family', strength: 3, reason: 'Sestrične. Jill je bila patološki ljubomorna na Sidneyinu slavnu sudbinu.' },
    { source: 'sidney-prescott', target: 'roman-bridger', type: 'family', strength: 3, reason: 'Polubrat i polusestra. Roman je bio tajni arhitekt Sidneyine noćne more.' },
    { source: 'mrs-loomis', target: 'billy-loomis', type: 'family', strength: 5, reason: 'Majka i sin. Nancy Loomis je pokrenula Scream 2 masakr kako bi osvetila Billyjevu smrt.' },
    { source: 'billy-loomis', target: 'sam-carpenter', type: 'family', strength: 5, reason: 'Otac i izvanbračna kći. Samin identitet opterećen je Billyjevim nasilnim genima i vizijama.' },
    { source: 'sam-carpenter', target: 'tara-carpenter', type: 'family', strength: 5, reason: 'Polusestre i srž Core Four saveza. Njihova sestrinska ljubav preživljava sve napade.' },
    { source: 'randy-meeks', target: 'martha-meeks', type: 'family', strength: 5, reason: 'Brat i sestra, čuvari izvornih filmskih pravila.' },
    { source: 'martha-meeks', target: 'chad-meeks-martin', type: 'family', strength: 5, reason: 'Majka i sin.' },
    { source: 'martha-meeks', target: 'mindy-meeks-martin', type: 'family', strength: 5, reason: 'Majka i kći.' },
    { source: 'chad-meeks-martin', target: 'mindy-meeks-martin', type: 'family', strength: 5, reason: 'Blizanci s neraskidivom telepatskom i preživljavajućom vezom.' },
    { source: 'det-wayne-bailey', target: 'richie-kirsch', type: 'family', strength: 5, reason: 'Otac i sin. Detektiv Bailey osmislio je njujorški masakr kako bi osvetio Richijeve ubojice.' },
    { source: 'det-wayne-bailey', target: 'ethan-landry', type: 'family', strength: 5, reason: 'Otac i sin, urotili su se u New Yorku radi osvete za Richieja.' },
    { source: 'det-wayne-bailey', target: 'quinn-bailey', type: 'family', strength: 5, reason: 'Otac i kći, lažirali su njezinu smrt kako bi se infiltrirali među žrtve.' },
    { source: 'sidney-prescott', target: 'mark-kincaid', type: 'romantic', strength: 5, reason: 'Supružnici. Detektiv Kincaid je postao Sidneyin životni zaštitnik i otac njezine djece.' },
    { source: 'sidney-prescott', target: 'tatum-prescott', type: 'family', strength: 5, reason: 'Majka i kći. Nazvana po njezinoj pokojnoj najboljoj prijateljici Tatum Riley.' },
    { source: 'sidney-prescott', target: 'emma-prescott', type: 'family', strength: 5, reason: 'Majka i kći.' },
    { source: 'sidney-prescott', target: 'rebecca-prescott', type: 'family', strength: 5, reason: 'Majka i kći.' },

    // romantic
    { source: 'sidney-prescott', target: 'billy-loomis', type: 'romantic', strength: 5, reason: 'Prvi dečko i ubojica. Billyjeva izdaja obilježila je cijeli Sidneyin život.' },
    { source: 'gale-weathers', target: 'dewey-riley', type: 'romantic', strength: 5, reason: 'Komična i tragična ljubavna priča Woodsboroa koja je trajala kroz pet filmova.' },
    { source: 'sam-carpenter', target: 'richie-kirsch', type: 'romantic', strength: 5, reason: 'Dečko i ubojica. Richie se infiltrirao u njezin život radi fanatične opsesije filmovima.' },
    { source: 'sam-carpenter', target: 'danny-brackett', type: 'romantic', strength: 4, reason: 'Susjed i dečko koji joj je pomogao preživjeti napade u New Yorku.' },
    { source: 'tara-carpenter', target: 'chad-meeks-martin', type: 'romantic', strength: 5, reason: 'Prijatelji iz djetinjstva čija je ljubav procvjetala tijekom zajedničkog proživljavanja trauma.' },
    { source: 'jill-roberts', target: 'charlie-walker', type: 'romantic', strength: 4, reason: 'Uvrnuti saveznik. Charlie je ubijao nadajući se da će postati njezin "Billy Loomis".' },

    // Deadly Links & Alliances
    { source: 'roman-bridger', target: 'billy-loomis', type: 'rivalry', strength: 5, reason: 'Mentorstvo i manipulacija. Roman je otkrio tajnu Billyju i potaknuo ga na ubojstvo Maureen.' }, 
    { source: 'billy-loomis', target: 'stu-macher', type: 'friendship', strength: 5, reason: 'Originalni ubilački dvojac iz 1996. godine.' },
    { source: 'mrs-loomis', target: 'mickey-altieri', type: 'friendship', strength: 5, reason: 'Udruženi ubojice s fakulteta u Windsoru.' },
    { source: 'richie-kirsch', target: 'amber-freeman', type: 'friendship', strength: 5, reason: 'Udruženi ubojice s interneta, opsjednuti oživljavanjem franšize u originalnoj Stuovoj kući.' },
    { source: 'jessica-bowden', target: 'marco-davis', type: 'friendship', strength: 5, reason: 'Udruženi ubojice iz ustanove u Scream 7 (2026.).' },
    { source: 'jessica-bowden', target: 'karl-gibbs', type: 'friendship', strength: 5, reason: 'Udruženi urotnici s motivom destabilizacije Sidney Prescott.' },
    { source: 'amber-freeman', target: 'dewey-riley', type: 'killer-victim', strength: 5, reason: 'Amber je brutalno ubila Deweya u bolnici, čime je prekinula nasljeđe legendarnog šerifa.' },
    { source: 'sam-carpenter', target: 'richie-kirsch', type: 'killer-victim', strength: 5, reason: 'Sam je oslobodila svoj unutarnji nasilni alter-ego kako bi izbola Richieja na smrt.' },
    { source: 'nancy-loomis', target: 'randy-meeks', type: 'killer-victim', strength: 5, reason: 'Nancy je u naletu bijesa i prkosa ubila Randyja u reportažnom kombiju.' },
    { source: 'roman-bridger', target: 'cotton-weary', type: 'killer-victim', strength: 5, reason: 'Roman je ubio Cottona jer je odbio predati informaciju o tome gdje se Sidney skriva.' },
    { source: 'jill-roberts', target: 'charlie-walker', type: 'killer-victim', strength: 5, reason: 'Završna izdaja. Jill je ubila Charlieja kako bi sebe predstavila kao jedinu nevinu žrtvu.' },
    { source: 'maureen-prescott', target: 'cotton-weary', type: 'romantic', strength: 4, reason: 'Izvanbračna afera koja je dovela do lažnog optuživanja Cottona za njezinu smrt.' }, 
    { source: 'sidney-prescott', target: 'hallie-mcdaniel', type: 'friendship', strength: 5, reason: 'Cimerica i najbolja prijateljica na fakultetu koja je stradala od ruku ubojice.' },
    { source: 'sidney-prescott', target: 'derek-feldman', type: 'romantic', strength: 5, reason: 'Tragična ljubav na fakultetu. Derek je upucan pred Sidneyinim očima.' },
    { source: 'gale-weathers', target: 'jennifer-jolie', type: 'friendship', strength: 3, reason: 'Komično i napeto suparništvo i suradnja novinarke i glumice koja ju je utjelovila.' },
    { source: 'jill-roberts', target: 'olivia-morris', type: 'friendship', strength: 5, reason: 'Prijateljstvo koje je služilo kao paravan za Jillino stravično planiranje njezina ubojstva.' },
    { source: 'kirby-reed', target: 'olivia-morris', type: 'friendship', strength: 5, reason: 'Srednjoškolske školske prijateljice iz Woodsboroa.' },
    { source: 'judy-hicks', target: 'wes-hicks', type: 'family', strength: 5, reason: 'Majka šerifica i voljeni sin čija su ubojstva šokirala obitelj.' },
    { source: 'mindy-meeks-martin', target: 'anika-kayoko', type: 'romantic', strength: 5, reason: 'Njujorška ljubav. Anika je tragično pala s ljestava u jednom od najbrutalnijih ubojstava.' },
    { source: 'mickey-altieri', target: 'derek-feldman', type: 'killer-victim', strength: 5, reason: 'Mickey je ubio Dereka zavezanog na pozornici kako bi psihički slomio Sidney.' },
    { source: 'mickey-altieri', target: 'cici-cooper', type: 'killer-victim', strength: 5, reason: 'Mickey je bacio Cici s balkona sestrinstva u Windsoru.' },
    { source: 'amber-freeman', target: 'wes-hicks', type: 'killer-victim', strength: 5, reason: 'Amber je iznenadila i ubila Wesa u vlastitoj kući u Woodsborou.' },
  ]
};
